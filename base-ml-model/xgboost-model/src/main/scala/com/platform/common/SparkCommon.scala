...
object SparkCommon {
  ...
  //是否在standalone模式下
  val SPARK_RUN_MODE_STANDALONE = "spark.commons.standalone"
  ...
  /**
    * mysql
    */
  val DB_JDBC_URL = "mysql.jdbc.url"

  val DB_USER_NAME = "mysql.jdbc.username"

  val DB_PASSWORD = "mysql.jdbc.password"

  val DB_DRIVER_CLASS_NAME = "mysql.jdbc.driver"

  /**
    * model
    */
  val MODEL_PATH = "model.modelPath"
}
