...
@Log4j2
@Component
public class FactoryNoALxSalaryHandleImpl extends AbstractConsumeHandle {
    ...
    protected String getDataType() {
        return DataTypeConstant.FACTORY_NON_A_LX_SALARY;
    }

    @Override
    public void handle(List<FlatMessage> messageList,String dataType) {
        new HbaseSalaryHandle().addSalaryCommon(messageList,dataType,HBaseConstant.FAMILY_FACTORY_NON_A_LX_SALARY_INFO,HBaseConstant.TABLE_FACTORY_NON_A_LX_SALARY,hbaseTemplate);
    }
