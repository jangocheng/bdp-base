...
@Component
@Log4j2
public class FactoryIdpgIdpbgSalaryHandleImpl extends AbstractConsumeHandle {
    ...
    protected String getDataType() {
        return DataTypeConstant.FACTORY_IDPG_IDPBG_SALARY;
    }

    @Override
    public void handle(List<FlatMessage> messageList, String dataType) {
        new HbaseSalaryHandle().addSalaryCommon(messageList,dataType,HBaseConstant.FAMILY_FACTORY_IDPG_IDPBG_SALARY,HBaseConstant.TABLE_FACTORY_IDPG_IDPBG_SALARY,hbaseTemplate);
    }
