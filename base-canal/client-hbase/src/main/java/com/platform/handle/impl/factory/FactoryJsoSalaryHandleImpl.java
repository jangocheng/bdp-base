...
@Log4j2
@Component
public class FactoryJsoSalaryHandleImpl extends AbstractConsumeHandle {
    ...
    protected String getDataType() {
        return DataTypeConstant.FACTORY_JSO_SALARY;
    }

    @Override
    public void handle(List<FlatMessage> messageList,String dataType) {
        new HbaseSalaryHandle().addSalaryCommon(messageList,dataType,HBaseConstant.FAMILY_FACTORY_JSO_SALARY_INFO,HBaseConstant.TABLE_FACTORY_JSO_SALARY,hbaseTemplate);
    }
