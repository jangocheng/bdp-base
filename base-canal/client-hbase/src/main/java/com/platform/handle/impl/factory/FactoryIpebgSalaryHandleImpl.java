...
@Component
@Log4j2
public class FactoryIpebgSalaryHandleImpl extends AbstractConsumeHandle {
    ...
    protected String getDataType() {
        return DataTypeConstant.FACTORY_IPEBG_SALARY;
    }

    @Override
    public void handle(List<FlatMessage> messageList, String dataType) {
        new HbaseSalaryHandle().addSalaryCommon(messageList,dataType,HBaseConstant.FAMILY_FACTORY_IPEBG_SALARY_INFO,HBaseConstant.TABLE_FACTORY_IPEBG_SALARY,hbaseTemplate);
    }
