 ...
 * @Description: FII CESGB集团薪资数据
 * @date 2020/11/162:37 PM
 *
 */
@Component
@Log4j2
public class FactoryFiiCesgbSalaryHandleImpl extends AbstractConsumeHandle {
    ...
    protected String getDataType() {
        return DataTypeConstant.FACTORY_FII_CESGB_SALARY;
    }

    @Override
    public void handle(List<FlatMessage> messageList, String dataType) {
        new HbaseSalaryHandle().addSalaryDailySumCommon(messageList,dataType,HBaseConstant.FAMILY_FACTORY_FII_CESGB_SALARY,HBaseConstant.TABLE_FACTORY_FII_CESGB_SALARY,hbaseTemplate);
    }
