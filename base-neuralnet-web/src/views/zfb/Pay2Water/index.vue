...
import PayIndicatorsByTime from './PayIndicatorsByTime';
import pay2WaterTable from './pay2WaterTable.vue';
...
export default {
  ...
  methods: {
    async getChanel() {
      ...
      const { dateType, sourceType, targetType, payType } = res.data;
      this.timeEunm = dateType;
      this.channelEmnu = targetType;
      this.osTypeEunm = sourceType;
      this.payTypeEunm = payType;
    },
    // 初始化时间
    initTimeSeries() {
    ...
    healderQuery() {
      ...
      // 更新渠道报表
      this.$refs.payIndicatorsByTime.getPayIndicatorsByTimeQuery();
      this.$refs.pay2WaterTable.getPay2waterTable(true);
    },
  },
};
</script>
