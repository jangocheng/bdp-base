 ...
 */
@Data
@FileNameAnnotation(value = "逾期表")
public class FinanceOverdueReportListRO {
     ...
     * 十四级分类
     */
    @ExportBeanFieldAnnotation(sort = 8, title = "十四级分类")
     ...
     * 逾期本金
     */
    @ExportBeanFieldAnnotation(sort = 9, title = "逾期本金")
     ...
     * 逾期利息
     */
    @ExportBeanFieldAnnotation(sort = 10, title = "逾期利息")
     ...
     * 逾期罚息
     */
    @ExportBeanFieldAnnotation(sort = 11, title = "逾期罚息")
     ...
     * 逾期服务费
     */
    @ExportBeanFieldAnnotation(sort = 12, title = "逾期服务费")
    @ApiModelProperty("逾期服务费")
    private BigDecimal serviceAmount;

    /**
     * 合计
     */
    @ExportBeanFieldAnnotation(sort = 13, title = "合计")
    @ApiModelProperty("合计")
