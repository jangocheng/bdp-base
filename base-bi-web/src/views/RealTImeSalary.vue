...
// import echartSyncDate from '../components/realTImeSalary/echartSyncDate'; //各业务部门推送数据
import { toThousands } from '@/utils/tool';
import echartData from '../components/realTImeSalary/echartData'; //各业务部门交易金额
import echartGauge from '../components/realTImeSalary/echartGauge'; //各业务部门交易金额
import testData from '../components/realTImeSalary/testData'; //各业务部门交易金额
import {
  syncData,
  consumeAmountData,
  consumeCountData,
