...
import { exportUndue, getUndue } from '@/api/balance'
import { IbalanceUndue } from '@/api/types'
...
export default class extends Vue {
    ...
    private async getList(btnClick: boolean = true) {
      ...
      let res = await getUndue(this.ListParam)
      this.tableData = res.data.financeUndueReportListROList
    ...
    private async exportUndue() {
      let res = await exportUndue(this.exportParam)
    }
}
</script>
